    ...
    <p-popover #op>
      <div style="display: flex; flex-direction: column; gap: 0.5rem; max-width: 280px;">
        <div style="display: flex; align-items: flex-start; gap: 0.5rem;">
          ...
          <div>
            <strong>Owner</strong><br /><span style="font-size: 0.85rem; opacity: 0.8;"
              >Manage board, manage tasks, and manage board members.</span
            >
          </div>
        </div>
        <div style="display: flex; align-items: flex-start; gap: 0.5rem;">
          ...
          <div>
            <strong>Editor</strong><br /><span style="font-size: 0.85rem; opacity: 0.8;"
              >Manage tasks, but cannot manage board and board members.</span
            >
          </div>
        </div>
        <div style="display: flex; align-items: flex-start; gap: 0.5rem;">
          ...
          <div>
            <strong>Viewer</strong><br /><span style="font-size: 0.85rem; opacity: 0.8;"
              >Can only view board content.</span
            >
          </div>
        </div>
      </div>
